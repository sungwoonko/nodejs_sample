...
interface Job{ // type으로 변경하면 중복 코드 오류가 발생할 수 있음음
    company : string;
}
...
// printText("Hello, world","centre"); // 특정 값을 타입화 하는 것이지만 , 재사용성이 떨어져서 다음으로 대체함
...
function checkDayType(): void {
    ...
    const isWorkingDay = 
        ...
        currentDay !== Day.Monday && currentDay !== Day.Wenesday;
